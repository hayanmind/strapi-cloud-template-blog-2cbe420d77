...
export interface ApiClassClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    numOfStudents: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['active', 'finish']>;
...
export interface ApiServiceUserServiceUser extends Struct.CollectionTypeSchema {
  collectionName: 'service_users';
  info: {
    description: '';
    displayName: 'Service User';
    pluralName: 'service-users';
    singularName: 'service-user';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    password: Schema.Attribute.Password;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['teacher', 'student']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    password: Schema.Attribute.Password;
    publishedAt: Schema.Attribute.DateTime;
    readingLevel: Schema.Attribute.Decimal;
    readingLevelUpdated: Schema.Attribute.DateTime;
    studentId: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    studentStatus: Schema.Attribute.Enumeration<
      ['inUse', 'notInUse', 'notRegistered']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'inUse'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTestRecordTestRecord extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    submitStatus: Schema.Attribute.Enumeration<
      ['submitted', 'waitForSubmit', 'notSubmitted']
    >;
...
export interface ApiTestTest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    startingLevel: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    testRecords: Schema.Attribute.Relation<
      'oneToMany',
      'api::test-record.test-record'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::service-user.service-user': ApiServiceUserServiceUser;
      'api::student.student': ApiStudentStudent;
      'api::test-record.test-record': ApiTestRecordTestRecord;
